...
router.get("/get-dashboard-data", checkoutAuth, WithdrawlRequestController.UserDashBoardData)
router.get("/get-all-refrels", checkoutAuth, WithdrawlRequestController.AllRefferalData)

router.get("/get-image", OrderController.GetGallery)

router.get("/get-qr", GalleryController.GetQr)
